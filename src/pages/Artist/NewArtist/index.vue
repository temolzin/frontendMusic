          ...
          >
            ...
            <div class="row content-center">
              ...
              <q-input
                ...
                hint="Ingresa el precio por hora"
                type="number"
                lazy-rules
                :rules="[
                  (val) =>
              ...
              <q-checkbox
                ...
                v-model="check"
                @click="isCheck"
                label="Clic si eres tú el manager"
                checked-icon="task_alt"
                unchecked-icon="highlight_off"
              />

              <q-input
                v-model="formCreate.name_manager"
                class="col-12 col-sm-5 q-ma-sm"
              ...
              <q-input
                v-model="formCreate.phone_manager"
                class="col-12 col-sm-5 q-ma-sm"
              ...
              <q-input
                v-model="formCreate.email_manager"
                class="col-12 col-sm-10 q-ma-sm"
                label="Correo electrónico del manager"
                lazy-rules
                type="email"
                :rules="[
                  (val) => (val && val.length > 0) || 'Por favor ingresa algo',
...
export default {
  ...
  methods: {
    ...
    isCheck() {
      if (this.check == true) {
        this.formCreate.name_manager = this.getMe.name;
        this.formCreate.email_manager = this.getMe.email;
      } else {
        this.formCreate.name_manager = "";
        this.formCreate.email_manager = "";
      }
    },
    showInfoArtist() {
      this.showInfo = "none";
